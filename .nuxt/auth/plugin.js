...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/api/user/login","method":"post","propertyName":"token"},"logout":{"url":"/api/account/logout","method":"post"},"user":{"url":"https://data.vuamarketing.com:443/api/account/info","method":"get","propertyName":"phone"}},"tokenRequired":true,"tokenType":"","_name":"local"}))
